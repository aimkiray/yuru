          ...
          <li key={episodeItem.id}>
            <div className={`text-sm ${styles["row-expand"]}`}>
              <div className='text-left hover:cursor-pointer'
                ...
                {/* <input className={`relative top-1 appearance-none h-4 w-4 rounded-none border border-primary ${episodeItem.confirmed ? 'bg-tertiary' : ''}`} type="checkbox" checked={episodeItem.confirmed} /> */}
